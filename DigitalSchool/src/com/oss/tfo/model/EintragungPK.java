...
/**
 * The primary key class for the eintragung database table.
 * 
 */
@Embeddable
public class EintragungPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof EintragungPK)) {
			return false;
		}
		EintragungPK castOther = (EintragungPK)other;
		return 
